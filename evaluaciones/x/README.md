...
- ✅ Firma automática opcional: todas las tarjetas de generación incluyen el switch
  **Firmar documentos**, activado por defecto. Cuando José Eliseo Martínez Rodríguez
  aparece en un campo de firma, su firma WebP se incorpora automáticamente al PDF o Word.
